...
const TITLE = "Thư viện ảnh Zenova Cruise | Không gian du thuyền 6 sao";
const DESC =
  "Khám phá toàn bộ không gian Zenova Cruise: ngoại thất, nhà hàng, khu giải trí, spa và phòng nghỉ hướng vịnh Hạ Long - Lan Hạ.";
