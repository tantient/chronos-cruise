...
const translations: Record<Lang, Translations> = {
  vi: {
    ...
    earlyAccess: {
      ...
      success: "Cảm ơn bạn. Zenova sẽ liên hệ sớm.",
    ...
    teaserForm: {
      ...
      subtitle: "Để lại thông tin, đội ngũ Zenova sẽ gửi ưu đãi đầu tiên khi tàu chính thức khai trương.",
      name: "Họ tên",
      phone: "Số điện thoại",
      email: "Email",
      date: "Ngày dự kiến",
    ...
    recruitTeaser: {
      ...
      submit: "Gửi hồ sơ",
      success: "Đã nhận hồ sơ! Zenova sẽ liên hệ bạn sớm.",
    ...
    careers: {
      ...
      openingsSubtitle: "Xem các vị trí đang tuyển và liên hệ bộ phận nhân sự Zenova qua Zalo hoặc email bên dưới.",
  ...
  en: {
    ...
    earlyAccess: {
      ...
      contactPlaceholder: "email@example.com",
      submit: "Notify me",
      success: "Thank you. Zenova will reach out soon.",
    ...
    teaserForm: {
      ...
      subtitle: "Leave your details and Zenova will send the first offers when the cruise officially launches.",
      name: "Full name",
      phone: "Phone number",
      email: "Email",
      date: "Expected date",
    ...
    recruitTeaser: {
      ...
      submit: "Apply now",
      success: "Application received! Zenova will contact you soon.",
    ...
    careers: {
      ...
      openingsSubtitle: "Review the open roles and contact the Zenova HR team via Zalo or email below.",
